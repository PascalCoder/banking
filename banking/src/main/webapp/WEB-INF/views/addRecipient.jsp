...
<body>
	...
	<div class="container">
		<div class="row main"> <!--main-->
				<h2 class="title">Recipient Form</h2>
				<div class="col-md-6 col-md-offset-3 main-center"> <!--  main-center -->
					...
					<form:form class="" method="post" action="${pageContext.request.contextPath}/addRecipient"><!-- commandName="transaction" -->
					...
					<div class="row">
						...
						<div class="col-md-8 col-md-offset-2"> <!--col-md-offset-0-->
							...
							<div class="form-group">
								<label for="accountFrom">Add Recipient: </label>
							...
							<div class="form-group row">
								<div class="col-md-8 col-md-offset-2">
									<label for="amount" class="cols-sm-2 control-label">Account Number</label> <!---->
									<div class="cols-sm-8"> <!-- col-md-10-->
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
											<input type="text" class="form-control" name="accountNumber" id="accoount-number"  placeholder="Enter account number"/>
