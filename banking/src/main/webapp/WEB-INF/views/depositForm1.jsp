...
<body>
	...
	<div class="container">
		<div class="row main"> <!--main-->
				<h2 class="title">Deposit Form</h2>
				<div class="col-md-6 col-md-offset-3 main-center"> <!--  main-center -->
				<h5>Please enter amount you want to deposit</h5>
					<form:form class="" method="post" action="${pageContext.request.contextPath}/transaction/deposit" commandName="transaction">
					...
					<div class="row">
							...
							<div class="form-group">
								...
								<div class="cols-sm-10"> <!---->
									<div class="input-group">
										...
										<form:input type="text" class="form-control" path="amount" id="amount"  placeholder="Enter amount"/>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group col-md-6 col-md-offset-3">
							...
							<button type="submit" id="button" class="btn btn-primary btn-lg btn-block login-button">Make Deposit</button>
						</div>	
					</form:form>
				</div>
			</div>
